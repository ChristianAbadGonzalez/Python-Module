...
# Implementa métodos para agregar una tarea, marcar una tarea como completada y mostrar todas las tareas
...
lista_tareas.agregar_tarea("Hacer la compra semanal")
lista_tareas.agregar_tarea("Estudiar programación orientada a objetos")
