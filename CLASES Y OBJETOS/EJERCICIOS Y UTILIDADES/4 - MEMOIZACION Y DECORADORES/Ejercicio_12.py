# ================================================================ MEMOIZACION Y DECORADORES - ANALISIS DE TEXTO ================================================================
# ===============================================================================================================================================================================

# Imagina que estás trabajando en un sistema de análisis de texto que requiere calcular la frecuencia de ocurrencia de palabras en un conjunto de documentos. 
# Implementa una función llamada calcular_frecuencia_palabras que tome como entrada un texto y devuelva un diccionario que muestre la frecuencia de cada palabra en el texto.
...
#   3. Utiliza memoización para evitar recalcular la frecuencia de palabras para el mismo texto.
